...
import com.amazonaws.operators.PreLoadEnrichmentData;
...
public class ProcessStreamPreLoadReferenceData {
    private static final Logger LOG = LoggerFactory.getLogger(ProcessStreamPreLoadReferenceData.class);
    ...
    public static void main(String[] args) throws Exception {
        ...
        customerStream = customerStream
                ...
                .flatMap(new PreLoadEnrichmentData());
